...
void VDPAURenderer::renderFrame(AVFrame* frame)
{
    ...
    MyGuiContext local_context={0};
    local_context.displayWidth=m_DisplayWidth;
    local_context.displayHeight=m_DisplayHeight;

    local_context.m_VdpOutputSurfaceRenderBitmapSurface=(void*)m_VdpOutputSurfaceRenderBitmapSurface;
    local_context.m_VdpBitmapSurfaceDestroy=(void*)m_VdpBitmapSurfaceDestroy;
    local_context.m_VdpBitmapSurfaceCreate=(void*)m_VdpBitmapSurfaceCreate;
    local_context.m_VdpBitmapSurfacePutBitsNative=(void*)m_VdpBitmapSurfacePutBitsNative;
    local_context.VdpOutputSurfaceRenderBlendState=&m_OverlayBlendState;

    local_context.m_Device=m_Device;
    local_context.chosenSurface=chosenSurface;

    if(m_ImguiInited){
        mygui::InvokeUpdate(&local_context);
    }
